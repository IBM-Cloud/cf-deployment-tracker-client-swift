...
class MainTests : XCTestCase {
  ...
  var jsonOptions: JSON = [:]
    ...
    override func setUp() {
      super.setUp()
      #if os(OSX)
      	let data = options2.data(using: String.Encoding.utf8)
      #else
